	...
	<div class="container">
		...
		<section>
			...
			<div class="d-flex border border-success p-3">
				<div class="mr-3"><img width="100" src="http://image.genie.co.kr/Y/IMAGE/IMG_ALBUM/081/867/444/81867444_1616662460652_1_600x600.JPG"></div>
				<div>
					<h3>아이유</h3>
					<div>EDAM엔터테인먼트</div>
					<div>2008년 데뷔</div>
			...
			<table class="table text-center">
				<thead>
					<tr>
						...
						<th class="font-weight-bold">앨범</th>
					</tr>
				</thead>
